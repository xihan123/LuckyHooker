...
public class SoulHook implements Hook {
    public static final String hookPackageName = "cn.soulapp.android";

    @Override
    public void startHook(final XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        XposedBridge.log("start Hook Soul:" + lpparam.packageName);
    ...
    private void doHook(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        XposedHelpers.findAndHookMethod("cn.soulapp.android.client.component.middle.platform.utils.u.a", lpparam.classLoader, "k", XC_MethodReplacement.returnConstant(1));
