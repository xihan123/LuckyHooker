...
public class XmindHook implements Hook {


    public static final String hookPackageName = "net.xmind.doughnut";

    @Override
    public void startHook(final XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        XposedBridge.log("start Hook Xmind思维导图:" + lpparam.packageName);
    ...
    private void doHook(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        XposedHelpers.findAndHookMethod("net.xmind.doughnut.data.DUser", lpparam.classLoader, "j", XC_MethodReplacement.returnConstant(true));
