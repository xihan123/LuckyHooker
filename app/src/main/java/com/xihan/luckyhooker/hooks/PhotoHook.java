...
public class PhotoHook implements Hook {

    public static final String hookPackageName = "photo.editor.photoeditor.photoeditorpro";


    @Override
    public void startHook(final XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        XposedBridge.log("start Hook Polish:" + lpparam.packageName);
    ...
    private void doHook(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        XposedHelpers.findAndHookMethod("androidx.core.app.c", lpparam.classLoader, "i", Context.class,XC_MethodReplacement.returnConstant(true));
